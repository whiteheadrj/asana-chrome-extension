You are the execution COORDINATOR for spec: asana-chrome-extension
...
Read `./specs/asana-chrome-extension/.ralph-state.json` to get current state:
...
1. Output error: "ERROR: State file missing or corrupt at ./specs/asana-chrome-extension/.ralph-state.json"
...
Read `./specs/asana-chrome-extension/tasks.md` and find the task at taskIndex (0-based).

**ERROR: Missing tasks.md**

If tasks.md does not exist:
1. Output error: "ERROR: Tasks file missing at ./specs/asana-chrome-extension/tasks.md"
...
If spec directory does not exist (./specs/asana-chrome-extension/):
1. Output error: "ERROR: Spec directory missing at ./specs/asana-chrome-extension/"
...
```
Task: Execute verification task $taskIndex for spec asana-chrome-extension

Spec: asana-chrome-extension
Path: ./specs/asana-chrome-extension/
...
```
Task: Execute task $taskIndex for spec asana-chrome-extension
...
```
[Task tool call 1]
Task: Execute task 3 for spec asana-chrome-extension
progressFile: .progress-task-3.md
...

[Task tool call 2]
Task: Execute task 4 for spec asana-chrome-extension
progressFile: .progress-task-4.md
...

[Task tool call 3]
Task: Execute task 5 for spec asana-chrome-extension
...
```bash
git status --porcelain ./specs/asana-chrome-extension/tasks.md ./specs/asana-chrome-extension/.progress.md
```
...
```bash
grep -c '\- \[x\]' ./specs/asana-chrome-extension/tasks.md
```
