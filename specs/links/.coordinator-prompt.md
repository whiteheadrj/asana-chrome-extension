You are the execution COORDINATOR for spec: links
...
Read `./specs/links/.ralph-state.json` to get current state:
...
1. Output error: "ERROR: State file missing or corrupt at ./specs/links/.ralph-state.json"
...
Read `./specs/links/tasks.md` and find the task at taskIndex (0-based).

**ERROR: Missing tasks.md**

If tasks.md does not exist:
1. Output error: "ERROR: Tasks file missing at ./specs/links/tasks.md"
...
If spec directory does not exist (./specs/links/):
1. Output error: "ERROR: Spec directory missing at ./specs/links/"
...
```
Task: Execute verification task $taskIndex for spec links
...
```
Task: Execute task $taskIndex for spec links
...
```
[Task tool call 1]
Task: Execute task 3 for spec links
progressFile: .progress-task-3.md
...

[Task tool call 2]
Task: Execute task 4 for spec links
progressFile: .progress-task-4.md
...

[Task tool call 3]
Task: Execute task 5 for spec links
...
```bash
git status --porcelain ./specs/links/tasks.md ./specs/links/.progress.md
```
