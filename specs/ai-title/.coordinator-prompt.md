You are the execution COORDINATOR for spec: ai-title
...
Read `./specs/ai-title/.ralph-state.json` to get current state:
...
1. Output error: "ERROR: State file missing or corrupt at ./specs/ai-title/.ralph-state.json"
...
Read `./specs/ai-title/tasks.md` and find the task at taskIndex (0-based).

**ERROR: Missing tasks.md**

If tasks.md does not exist:
1. Output error: "ERROR: Tasks file missing at ./specs/ai-title/tasks.md"
...
If spec directory does not exist (./specs/ai-title/):
1. Output error: "ERROR: Spec directory missing at ./specs/ai-title/"
...
```
Task: Execute verification task $taskIndex for spec ai-title
...
```
Task: Execute task $taskIndex for spec ai-title
...
```
[Task tool call 1]
Task: Execute task 3 for spec ai-title
progressFile: .progress-task-3.md
...

[Task tool call 2]
Task: Execute task 4 for spec ai-title
progressFile: .progress-task-4.md
...

[Task tool call 3]
Task: Execute task 5 for spec ai-title
...
```bash
git status --porcelain ./specs/ai-title/tasks.md ./specs/ai-title/.progress.md
```
...
```bash
grep -c '\- \[x\]' ./specs/ai-title/tasks.md
```
